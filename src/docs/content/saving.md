...
Your drawing lives **only in this browser, on this device.** That's genuinely private (nothing is uploaded anywhere by default — see the [FAQ](/docs/faq)), but it also means:
